...
exports.createPropertyValidation = [
  ...
  // status is optional at creation because the Property model defaults it to 'for-sale'
  body('status').optional({ values: 'falsy' }).isIn(['for-sale', 'for-rent', 'sold', 'rented']).withMessage('Invalid status'),
