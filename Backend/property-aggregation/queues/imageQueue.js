/**
 * Image Queue - Queue for processing property image validation and enrichment.
 */
let Queue = null, QueueScheduler = null, connection = null, imageQueue = null;
try {
...
} catch (e) { console.warn('[ImageQueue] BullMQ not available'); }
class InMemoryQueue {
...
async function close() { if (imageQueue) { await imageQueue.close(); imageQueue = null; } }
