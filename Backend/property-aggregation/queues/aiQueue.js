...
async function getQueue() {
  ...
  if (Queue && connection) { try { aiQueue = new Queue('ai-queue', { connection }); if (typeof QueueScheduler === 'function') new QueueScheduler('ai-queue', { connection }); return aiQueue; } catch (e) {} }
